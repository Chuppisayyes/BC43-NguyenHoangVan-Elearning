            ...
            <div className="col-xl-3 col-lg-4">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://elearning0706.cybersoft.edu.vn/hinhanh/javascript-nang-cao_gp01.png";
                }}
                alt=""
              />
            </div>
            <div className="col-xl-7 col-lg-6 cardNetContent">
              ...
              <p className="colorCardTitle">
                {course.moTa.length > 50
                  ...
                  : "ES6 là một chuẩn Javascript mới được đưa ra vào năm 2015 với nhiều quy tắc và cách sử dụng khác nhau..."}
              </p>
              ...
              <div className="">
                <img
                  ...
                  alt=""
                />
                <span className="ml-2">Thanh Tiến</span>
              </div>
            </div>
        ...
        <div class="searchPage">
          <div className="row">
            ...
            <div className="col-xl-10 col-lg-9 col-md-8">
              ...
              <div className="mt-3 courseSearchResult">{rederSearchPage()}</div>
            </div>
          </div>
        </div>
      </section>
