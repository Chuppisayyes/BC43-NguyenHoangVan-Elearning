      ...
      <section className="About">
        <div className="sliderAbout">
          <div className="sliderContentAbout">
            <p className="titleSliderAbout">VCyber Academy học là vui </p>
        ...
        <div className="AboutItem">
          <div className="row">
            ...
            <div className="col-md-6 bgAboutGreen">
              <img
                src={require("../../Assets/Img/imgAbout/hero-flex.png").default}
                alt=""
              />
            </div>
          </div>
        ...
        <div className="AboutItem ">
          <div className="row reAboutItem">
            <div className="col-md-6 bgAboutBlue ">
              <img
                src={
                  require("../../Assets/Img/imgAbout/education-hero.png")
                    .default
                }
                alt=""
              />
            ...
            <div className="col-md-6">
              <h6>Chương trình học VCyber Academy</h6>
        ...
        <div className="AboutItem">
          <div className="row">
            ...
            <div className="col-md-6 bgAboutGreen">
              <img
                src={require("../../Assets/Img/imgAbout/olstudy.png").default}
                alt=""
              />
            </div>
          </div>
        ...
        <div className="AboutItem">
          <div className="row reAboutItem">
            <div className="col-md-6 bgAboutBlue">
              <img
                src={require("../../Assets/Img/imgAbout/students.png").default}
                alt=""
              />
            </div>
            <div className="col-md-6">
              <h6>Sứ mệnh VCyber Academy</h6>
              ...
              <p>
                ...
                yêu cầu từ các công ty, doanh nghiệp. Qua đó, VCyber Academy giúp
