...
export default function DetailCourse(props) {
  ...
  const { courseDetail, coursesList } = useSelector(
            ...
            >
              ...
              <div className="cardBodyGlobal">
                ...
                <div className="cardIcon">
                  <span>
                    <i className="far fa-clock iconOclock"></i>9 giờ
                  </span>
                  <span>
                    <i className="far fa-calendar-alt iconCalendar"></i>15 tuần
                  </span>
                  <span>
              ...
              <div className="cardFooter">
                <div className="titleMaker">
                  ...
                  <span className="ml-2 colorCardTitle">Ricard Jack</span>
                </div>
                <div>
                  <p>
                    800.000<sup>đ</sup>
            ...
            <NavLink to={`/chitiet/${course.maKhoaHoc}`} className="cardGlobal">
              <img
                ...
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://canhme.com/wp-conteniconCalendart/uploads/2018/09/Nodejs.png";
                }}
                alt=""
              />
              <span className="stikerCard">
    ...
    <>
      <section className="detailCoures">
          ...
          <div className="row">
            <div className="col-lg-8 col-md-7">
              <h4 className="titleDetailCourse">
                {courseDetail.tenKhoaHoc.length > 18
                ...
                <div className="courseDetailItem">
                  <div className="courseDetailContent">
                    <div className="sectionCourse">
                      ...
                      <button className="btnGlobal btnPreview">
                        Xem trước
                      </button>
                    </div>
                    <p>Bài học</p>
              ...
              <div className="sideBarCourseDetail">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://codersera.com/blog/wp-content/uploads/2019/12/Learn-Reactjs-672x372.jpeg";
                  }}
                  alt=""
                />
        ...
        <div className="coursesRelated">
          ...
          <div className="row">{renderCourseRelated()}</div>
        </div>
      </section>
    </>
  );
