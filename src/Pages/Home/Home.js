  ...
  const renderCoursePopular = () => {
    return coursesList?.slice(0, 4).map((course, index) => {
      return (
        <div
          key={index}
          className="col-md-6 col-xl-3 cardGlobalRes mt-4 cardEffect"
        >
          <NavLink to={`/chitiet/${course.maKhoaHoc}`} className="cardGlobal">
            <img
              ...
              onError={(e) => {
                ...
                e.target.src =
                  "https://ectimes.files.wordpress.com/2019/03/cac-ngon-ngu-lap-trinh-pho-bien-2.jpg";
              }}
              alt=""
            />
            <span className="stikerCard">
              {course.tenKhoaHoc.length > 5
                ? course.tenKhoaHoc
                : "Lập trình web"}
            </span>
              ...
              <div className="titleMaker">
                <div className="imgCardFooter">
                  <img
                    className=""
                    src={
                      require("../../Assets/Img/ImgAvatar/avatar2.png").default
                    }
                    alt=""
                  />
                </div>
            ...
            >
              <img
                ...
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src =
                    "https://codelearn.io/Upload/Blog/moi-truong-node-js-browser-va-khac-biet-63745001344.3067.jpg";
                }}
                alt=""
              />
              <span className="stikerCard">
                {course.tenKhoaHoc.length <= 10
                  ? course.tenKhoaHoc
                  : "Lập trình web"}
              </span>
              <div className="cardBodyGlobal">
                ...
                <div className="titleMaker">
                  <div className="imgCardFooter">
                    <img
                      className=""
                      src={
                        require("../../Assets/Img/ImgAvatar/avatar2.png")
                          .default
                      }
                      alt=""
                    />
              ...
              <div className="subCard">
                <div className="subCardHead">
                  <img
                    src={
                      require("../../Assets/Img/ImgAvatar/emoji.png").default
                    }
                    alt=""
                  />
  ...
  return (
    <>
      <div className="homePage">
            ...
            <div className="sloganContainer">
              <div>
                <img
                  ...
                  src={
                    require("../../Assets/Img/imgSlider/paper_plane.png")
                      .default
                  }
                  alt=""
                />
            ...
            <div className="sliderRight">
              ...
              <div>
                <img
                  ...
                  src={
                    require("../../Assets/Img/imgSlider/slider2.png").default
                  }
                  alt=""
                />
                <img
                  ...
                  src={
                    require("../../Assets/Img/imgSlider/code_slider.png")
                      .default
                  }
                  alt=""
                />
                <img
                  ...
                  src={
                    require("../../Assets/Img/imgSlider/message_slider.png")
                      .default
                  }
                  alt=""
                />
                <img
                  ...
                  src={require("../../Assets/Img/imgSlider/clouds.png").default}
                  alt=""
                />
                <img
        ...
        <div className="row mt-4">{renderCoursePopular()}</div>
        {/* Course Student */}
        <div className="mt-5">
          <h6>
            <a href="">Khóa học tham khảo</a>
          </h6>
          <div className="row">{renderCourseStudent()}</div>
        </div>
        {/* Course Student */}
        <div className="mt-5">
          <h6>
          ...
          <div className="row">{renderCourseReact()}</div>
        </div>
      </div>
      {/* Box Number */}
      <div
        className="boxNumberContainer mt-5"
        style={{
          backgroundImage: "url('./Img/ImgLogo/bg-info-elearning.jpg')",
        }}
      >
        <div
          className="ie-overflow"
          style={{ backgroundImage: "url('./Img/ImgLogo/bg-2.png')" }}
        ></div>
        <div className="row">
          <div className="col-lg-3 p-4 col-md-6">
            <div className="boxNumber">
              <div>
                <img
                  src={
                    require("../../Assets/Img/imgIcon/003-students.png").default
                  }
                  className="imgIcon"
                  alt=""
                />
          ...
          <div className="col-lg-3 p-4 col-md-6">
            <div className="boxNumber">
              <div>
                <img
                  src={
                    require("../../Assets/Img/imgIcon/001-timetable.png")
                      .default
                  }
                  className="imgIcon"
                  alt=""
          ...
          <div className="col-lg-3 p-4 col-md-6">
            <div className="boxNumber">
              <div>
                <img
                  src={
                    require("../../Assets/Img/imgIcon/002-hourglass.png")
                      .default
                  }
                  className="imgIcon"
                  alt=""
          ...
          <div className="col-lg-3 p-4 col-md-6">
            <div className="boxNumber">
              <div>
                <img
                  src={
                    require("../../Assets/Img/imgIcon/004-teacher.png").default
                  }
                  className="imgIcon"
                  alt=""
                />
          ...
          <div className="row mt-4">
            <div className="col-lg-2 col-md-3 col-sm-6 col-12">
              <div className="instrutorContent">
                <img
                  src={
                    require("../../Assets/Img/imgInstrutors/instrutor5.jpg")
                      .default
                  }
                  alt=""
                />
                <h6>Trương Tấn Khải</h6>
                <div className="textReviewRole">
                  <p>Chuyên gia lĩnh vực</p>
                  <p>lập trình Javascipt</p>
                </div>
                <p className="reviewMentor">
                  ...
                  <i className="fas fa-star"></i>
                  <i className="fas fa-star"></i>
                  <span className="textStar"> 5.0</span>
                </p>
                <span className="textReviewBot">234 Đánh giá</span>
              </div>
            </div>
            <div className="col-lg-2 col-md-3 col-sm-6 col-12">
              <div className="instrutorContent">
                <img
                  src={
                    require("../../Assets/Img/imgInstrutors/instrutor6.jpg")
                      .default
                  }
                  alt=""
                />
                ...
                <p className="reviewMentor">
                  ...
                  <i className="fas fa-star"></i>
                  <i className="fas fa-star"></i>
                  <span className="textStar"> 4.8</span>
                </p>
                <span className="textReviewBot">156 Đánh giá</span>
              </div>
            </div>
            <div className="col-lg-2 col-md-3 col-sm-6 col-12">
              <div className="instrutorContent">
                <img
                  src={
                    require("../../Assets/Img/imgInstrutors/instrutor7.jpg")
                      .default
                  }
                  alt=""
                />
                <h6>Vũ Nguyễn Coder</h6>
                <div className="textReviewRole">
                ...
                <span className="textReviewBot">120 Đánh giá</span>
              </div>
            </div>
            <div className="col-lg-2 col-md-3 col-sm-6 col-12">
              <div className="instrutorContent">
                ...
                <p className="reviewMentor">
                  ...
                  <i className="fas fa-star"></i>
                  <i className="fas fa-star"></i>
                  <span className="textStar"> 4.6</span>
                </p>
                <span className="textReviewBot">93 Đánh giá</span>
              </div>
            </div>
          </div>
        </div>
