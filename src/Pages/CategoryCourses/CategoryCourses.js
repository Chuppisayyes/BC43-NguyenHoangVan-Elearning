                        ...
                        <NavLink to={`/chitiet/${course.maKhoaHoc}`} className="cardGlobal moveSubCard">
                            ...
                            <div className="cardBodyGlobal">
                                ...
                                <div className='cardIcon'>
                                    <span><i className="far fa-clock iconOclock"></i>6 giờ</span>
                                    <span><i className="far fa-calendar-alt iconCalendar"></i>16 tuần</span>
                            ...
                            <div className='cardFooter'>
                                <div className='titleMaker'>
                                    ...
                                    <span className='ml-2 colorCardTitle'>Master dekin</span>
                                </div>
                                <div>
                                    <p>1.680.000<sup>đ</sup></p>
                                    <p>1.400.000<sup>đ</sup><i className="fas fa-tag iconTag"></i></p>
                                </div>
                            ...
                            <div className='subCard'>
                                <div className='subCardHead'>
                                    ...
                                    <span className='ml-1 colorCardTitle'> Ricard Jack</span>
                                </div>
                                <h6>BOOTCAMP - LẬP TRÌNH FULL STACK TỪ ZERO ĐẾN CÓ VIỆC</h6>
                                <p className='colorCardTitle'>Đã có hơn 9224 bạn đăng kí học và có việc làm thông qua chương trình đào tạo Bootcamp Lập trình Front End chuyên nghiệp. Khóa học 100% thực hành cường độ cao theo dự án thực tế và kết nối doanh nghiệp hỗ trợ tìm việc ngay sau khi học...</p>
                                <div className='cardIcon'>
                                    <span><i className="far fa-clock iconOclock"></i>9 giờ</span>
                                    <span><i className="far fa-calendar-alt iconCalendar"></i>15 tuần</span>
                                    <span><i className="fas fa-signal iconLevel"></i>Tất cả</span>
                                </div>
                    ...
                    <div key={index} className="col-xl-3 col-lg-4 col-md-6 mt-4 cardGlobalRes">
                        <NavLink to={`/chitiet/${course.maKhoaHoc}`} className="cardGlobal">
                            ...
                            <div className="cardBodyGlobal">
                                <h6 className="">{course.moTa.length > 100 ? course.moTa.substr(0, 50) + '...' : 'Lập trình hiện đang là xu hướng trên toàn thế giới...'}</h6>
                                <div className='cardIcon'>
                                    <span><i className="far fa-clock iconOclock"></i>10 giờ</span>
                                    <span><i className="far fa-calendar-alt iconCalendar"></i>20 tuần</span>
                                    <span><i className="fas fa-signal iconLevel"></i>Tất cả</span>
                                </div>
                            </div>
                            <div className='cardFooter'>
                                <div className='titleMaker'>
                                    <div className='imgCardFooter'><img className='' src={require('../../Assets/Img/ImgAvatar/avatar2.png').default} alt="" /></div>
                                    <span className='ml-2 colorCardTitle'>The Weekend</span>
                                </div>
                                <div>
                                    <p>9.700.000<sup>đ</sup></p>
                                    <p>5.000.000<sup>đ</sup><i className="fas fa-tag iconTag"></i></p>
                                </div>
                            ...
                            <div className='subCard'>
                                ...
                                <h6>BOOTCAMP - LẬP TRÌNH FULL STACK TỪ ZERO ĐẾN CÓ VIỆC</h6>
                                <p className='colorCardTitle'>Đã có hơn 19230 bạn đăng kí học và có việc làm thông qua chương trình đào tạo Bootcamp Lập trình Front End chuyên nghiệp. Khóa học 100% thực hành cường độ cao theo dự án thực tế và kết nối doanh nghiệp hỗ trợ tìm việc ngay sau khi học...</p>
                                <div className='cardIcon'>
                                    <span><i className="far fa-clock iconOclock"></i>7 giờ</span>
                                    <span><i className="far fa-calendar-alt iconCalendar"></i>18 tuần</span>
                                    <span><i className="fas fa-signal iconLevel"></i>Tất cả</span>
                                </div>
                                <button className='btnGlobal btnSubCard'><NavLink to={`/chitiet/${course.maKhoaHoc}`}>Xem chi tiết</NavLink></button>
